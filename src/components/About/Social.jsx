...
const Social = (props) => {
  ...
  return (
    ...
    className = {props.socialOpen === !false ? "active" : ''} >
      ...
      <div className="Next-button" id = {openYtb === !false ? "active" : ""} onClick = {()=> setOpenYtb(!false)}>
        <h1>YOUTUBE</h1>
        <AiFillFastForward />
      </div>
      ...
      <div className = "Social-section" id = {openYtb === !false ? "hidden" : ""}>
        <motion.ul variants={dynamicBox} initial = "initial" animate = "animate">
          ...
          <motion.li variants={SocialTxtAni}>
            ...
            <a href = "https://www.instagram.com/dlwlrma/" className = "Social-button" target="_blank">
              +View more
            </a>
          ...
          <motion.li variants={SocialTxtAni}>
            ...
            <a href = "https://www.instagram.com/dlwlrma/" className = "Social-button">
              +View more
            </a>
      ...
      {openYtb && 
      (
      <Youtube setOpenYtb = {setOpenYtb} openYtb = {openYtb}/>
      )}
    </div>
  )
}
