...
const SingerIndex = ({ infoData, indexRef, gsap }) => {
  const leftSingerScrollRef = useRef(null);
  const rightSingerScrollRef = useRef(null);

  useEffect(() => {
    gsap.to(leftSingerScrollRef.current, {
      bottom: "0%",
      scrollTrigger: {
    ...
    gsap.to(rightSingerScrollRef.current, {
      bottom: "100%",
      scrollTrigger: {
        trigger: indexRef.current,
        scrub: 5,
    ...
    <div className='Singer-IndexBox'>
      ...
      <IndexScrollBox>
        <div className='Scroll-Index'>
          <div className='Left-Index' ref={leftSingerScrollRef}>
        ...
        <div className='Scroll-Index'>
          <div className='Right-Index' ref={rightSingerScrollRef}>
            <div className='item-Img'>
