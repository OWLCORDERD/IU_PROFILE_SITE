    ...
    >
      ...
      <div className="slider-container">
        <div
          ...
          id={activeClass == "slider-active" ? "active" : ""}
        >
            ...
            >
              <div className="Introduce-content">
                <motion.h1 variants={ContentsTitle} className="Introduce-title">
                  <p>
                    <strong>IU ,</strong>You and I <br></br> become one{" "}
                    <br></br> through music
                  </p>
                </motion.h1>

                <motion.p
                  variants={ContentsTitle}
                  className="Introduce-SubTitle"
                >
